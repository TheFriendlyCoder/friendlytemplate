...
@Command(name = "friendlytemplate", mixinStandardHelpOptions = true, version = "friendlytemplate 1.0",
...
class App implements Callable<Integer> {
    ...
    @Parameters(index = "0", description = "Source folder containing the template")
    private Path sourcePath;

    @Parameters(index = "1", description = "Output folder where the new source project is to be generated")
